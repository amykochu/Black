...
class Opportunity(models.Model):
    ...
    valuation_text = models.CharField(max_length=200, verbose_name='Valuation - metrics and rationale (Input)', blank=True, null=True)
    amount_invested = models.DecimalField(max_digits=15, decimal_places=4,
                                          verbose_name='Amount invested to date ($USm)', blank=True, null=True)
    ownership_structure = models.DecimalField(max_digits=15, decimal_places=4, verbose_name='Ownership structure (%)', blank=True, null=True)
    ebitda = models.DecimalField(max_digits=15, decimal_places=4, verbose_name='Company EBITDA ($USm)', blank=True, null=True)
    break_even_year = models.DecimalField(max_digits=15, decimal_places=4, verbose_name='Break-even year', blank=True, null=True)
    ...
    return_estimate = models.DecimalField(max_digits=15, decimal_places=4, verbose_name='Return estimate (3-yr) (%)', blank=True, null=True)
    growth_expectation_year1 = models.DecimalField(max_digits=15, decimal_places=4, verbose_name='Earnings growth expectation (%) Year 1', blank=True, null=True)
    growth_expectation_year2 = models.DecimalField(max_digits=15, decimal_places=4, verbose_name='Earnings growth expectation (%) Year 2', blank=True, null=True)
    growth_expectation_year3 = models.DecimalField(max_digits=15, decimal_places=4, verbose_name='Earnings growth expectation (%) Year 3', blank=True, null=True)
    ...
    amount_lead_partner = models.DecimalField(max_digits=15, decimal_places=4, verbose_name='Amount injected by Lead Partner', blank=True, null=True)
    amount_other_partner = models.DecimalField(max_digits=15, decimal_places=4, verbose_name='Amount injected by Other Partners', blank=True, null=True)
    amount_weraise = models.DecimalField(max_digits=15, decimal_places=4, verbose_name='Amount available for WeRaise', blank=True, null=True)
    ...
    deadline_commitment = models.DecimalField(max_digits=15, decimal_places=4, verbose_name='Deadline for formal commitment', blank=True, null=True)
    deadline_legal = models.DecimalField(max_digits=15, decimal_places=4, verbose_name='Deadline for execution of legal docs', blank=True, null=True)
...
class Mandate(models.Model):
    ...
    percentage_company = models.DecimalField(max_digits=15, decimal_places=4, verbose_name='% of company (min - max)')
    #
    geography = models.ForeignKey(Geography, on_delete=models.SET_NULL, null=True)
    country = models.ManyToManyField(Country)
    #
